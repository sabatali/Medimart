    ...
    <section className="service-section sec-pad">
      <div className="auto-container">
        <div className="sec-title mb_50 centred">
          ...
          <h2>Comprehensive Medical Billing <br />& Revenue Solutions</h2>
        </div>
            ...
            <div className="service-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
              <div className="inner-box">
                ...
                <div className="lower-content">
                  <h3><Link href="service-details">Claims Processing</Link></h3>
                  <p>Efficient and accurate processing of medical claims with advanced technology and expert oversight.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 col-sm-12 service-block">
            <div className="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
              <div className="inner-box">
                ...
                <div className="lower-content">
                  <h3><Link href="service-details">Revenue Management</Link></h3>
                  <p>Strategic revenue optimization through comprehensive billing analysis and denial management.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 col-sm-12 service-block">
            <div className="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="inner-box">
                ...
                <div className="lower-content">
                  <h3><Link href="service-details">Compliance & Security</Link></h3>
                  <p>HIPAA-compliant systems and secure data transmission ensuring patient privacy and regulatory compliance.</p>
                </div>
              </div>
            </div>
          </div>
