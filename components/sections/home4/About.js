          ...
          <div className="col-lg-6 col-md-12 col-sm-12 image-column">
            <div className="image_block_one">
              <div className="image-box">
                ...
                <figure className="image-2"><img src="assets/images/home4/about.png" alt="" /></figure>
            ...
            <div className="content_block_one">
              <div className="content-box ml_30">
                <div className="sec-title mb_15">
                  ...
                  <h2>Leading Medical Billing & Claims Processing</h2>
                </div>
                <div className="text-box mb_40">
                  <p>We are a dedicated team of medical billing professionals committed to helping healthcare providers maximize their revenue through efficient claims processing and management.</p>
                  <ul className="list-style-one clearfix">
                    <li>Advanced billing technology and software solutions</li>
                    <li>Experienced team with deep industry knowledge</li>
                    <li>Comprehensive compliance and security measures</li>
                  </ul>
                </div>
                <div className="lower-box">
                  <div className="experience-box">
                    ...
                    <h3>15+ Years</h3>
                    <span className="designation">Of Billing Experience</span>
                  </div>
